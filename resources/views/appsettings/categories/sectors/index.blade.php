              ...
              @foreach($cat_types as $cat_type)
                <tr @if($cat_type->is_active==FALSE) class="deactivated" @endif>
                  ...
                  <td class="icon_menu text-right">
                    <a href="/categories/sectors/edit/{{ $cat_type->id }}" class="name" data-toggle="tooltip" data-placement="left" title="Edit">
                    ...
                    @else
                      <a href="/categories/sectors/activate/{{ $cat_type->id }}" class="name" data-toggle="tooltip" data-placement="left" title="Activate">
